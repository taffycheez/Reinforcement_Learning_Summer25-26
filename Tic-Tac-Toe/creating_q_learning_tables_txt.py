...
q_table_vs_random = q_learning.play_tic_tac_toe(10000, 'learning', 'random', 100, 0.5)
q_table_vs_optimal = q_learning.play_tic_tac_toe(10000, 'learning', 'optimal', 100, 0.5)
q_table_both_learning = q_learning.play_tic_tac_toe(10000, 'learning', 'learning', 100, 0.5)
